...
class ExploreHelperTest < ActionView::TestCase
  ...
  test 'nyt explore results' do
    assert_not_empty find_explore_results('nyt', 'pancakes')
  end

  test 'epicurious explore results' do
    assert_not_empty find_explore_results('epicurious', 'pancakes')
  end

  test 'allrecipes explore results' do
    assert_not_empty find_explore_results('allrecipes', 'pancakes')
  end
