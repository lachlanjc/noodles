window.onload = function() {
    ...
    document.getElementById('cook-list').onclick = function() { go(Math.min(s.length - 1, ++big.current)); };
    document.getElementById('cookCtrlFwd').onclick = function() { go(Math.min(s.length - 1, ++big.current)); };
    document.getElementById('cookCtrlRev').onclick = function() { go(Math.max(0, --big.current)); };
